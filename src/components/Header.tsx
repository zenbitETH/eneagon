...
export default function Header() {
    return (
      <header className="fixed z-10 top-0 left-0 w-full bg-white text-op hover:bg-gradient-to-r hover:from-white hover:via-op/50 hover:to-op hover:text-white rounded-b-3xl text-center py-3 cursor-pointer">
        <Link href='https://round3.optimism.io/projects/0x904fafc79d5a1e200399edc47fbe95e69530075f8a699866ff7ccbd3f5567cb7'>
          <div className='grid grid-cols-6 items-center max-w-md xl:max-w-lg mx-auto  '>
            <Image src={retroPGF3} alt='retroPGF3' height={50} width={50} />
