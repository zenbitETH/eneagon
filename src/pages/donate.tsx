        ...
        <div className='card0 w-2/4 px-5'>
            <div className="donateCard">
                <div className="grid items-center text-center">
                    <div className="text-2xl text-color1-500 font-bold ">🌱 Stage 1 Donation</div>
                    <div className="w-2/4 mx-auto">
                        <label htmlFor="price" className="italic block text-left font-bold text-color1-500">
                          Set your donation
                        </label>
                        <div className="relative mt-1 rounded-dd shadow-sm ">
                            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                              <span className="text-color1-500 text-3xl">$</span>
                            </div>
                            <input
                              type="text"
                              name="price"
                              id="price"
                              className="block w-full rounded-gen border-gray-300 pl-7 pr-12 focus:border-color1-500 focus:ring-color1-500  text-3xl focus:text-color1-500"
                              placeholder="0.00"
                            />
                            <div className="absolute inset-y-0 right-0 flex items-center">
                                ...
                                <select
                                  id="currency"
                                  name="currency"
                                  className="h-full rounded-md border-transparent bg-transparent py-0 pl-2 pr-7 text-color1-500 font-bold focus:border-indigo-500 focus:ring-indigo-500 "
                                >
                                <option>USDC</option>
                                </select>
                            </div>
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div className="w-3/4 h-2/4 m-auto text-center">
                        <div className="text-2xl text-color1-500 font-bold">Vote to deliver funds</div>
